...
$this->con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    {
      // $current_time1 = new DateTime();SELECT * FROM snippets WHERE time_created < NOW() - INTERVAL 10 MINUTE;
      // $current_time = $current_time1 - 10*60;
        $sql2 = "select count(*) as at_count from attempts where address = '$ip' and timestamp > NOW() - INTERVAL 10 MINUTE";
        $stmt2 = $this->con->prepare($sql2);
        $count = $stmt2->execute();
        return $count['at_count'];
    }
