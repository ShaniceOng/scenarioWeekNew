...
if (file_exists("../resources/uploads/" . $username) == 0){
    mkdir("../resources/uploads/" . $username);
}
$target_dir = "../resources/uploads/". $username ."/";
...
// } else {
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
		...
		$username = $_SESSION['username'];
        $url = "http://localhost:8888/securelogin/resources/uploads/".$username. "/". $new_Filename;
